 ...
 *
 * No dependencies. Intl is in every browser and in Deno, which is what the
 * edge function runs on, so this module is shared by both sides.
 */
 ...
 *
 * This is how the 07:00 digest is scheduled: `wallClockToUTC('2026-11-01', 7)`
 * returns 11:00Z, and the day after the fall-back it returns 12:00Z. The
